...
======================================================================
Llegiu-me del LibreOffice 26.2
======================================================================
...
Si aprecieu l'esforç i voleu que el LibreOffice seguïsca estant disponible en el futur, considereu la possibilitat de contribuir al projecte. Visiteu www.libreoffice.org/community/get-involved per a obtindre més detalls. Tothom pot contribuir-hi d'alguna manera.
...
El directori RPMS (o DEBS, respectivament) també conté un paquet anomenat libreoffice26.2-freedesktop-menus-26.2.0.1-1.noarch.rpm (o libreoffice26.2-debian-menus_26.2.0.1-1_all.deb, respectivament, o similar). Aquest paquet és per a totes les distribucions de Linux que implementen les especificacions o recomanacions de Freedesktop (https://ca.wikipedia.org/wiki/Freedesktop.org), i es proporciona per a permetre la instal·lació en distribucions Linux que no estan mencionades en les instruccions.
...
La pàgina principal de suport  ofereix diverses possibilitats d'ajuda amb el LibreOffice. Potser la vostra pregunta ja ha estat contestada: consulteu el Fòrum de la Comunitat a https://ask.libreoffice.org/ o cerqueu en els arxius de la llista de correu 'users.libreoffice.org' a https://www.libreoffice.org/lists/users/. També podeu enviar preguntes a users.libreoffice.org. Si voleu subscriure-vos a la llista (per a obtindre respostes per correu electrònic), envieu un correu buit a: users+subscribe.libreoffice.org.
...
Esperem que gaudiu treballant amb el nou LibreOffice 26.2 i que us uniu a nosaltres en línia.
